...
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['t3lib/class.t3lib_tcemain.php']['clearPageCacheEval']['tx_dataquery'] = 'EXT:dataquery/class.tx_dataquery_cache.php:&tx_dataquery_cache->clearCache';

	// Register a hook with datafilter to handle the extra field added by dataquery
$GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['datafilter']['postprocessReturnValue']['tx_dataquery'] = 'EXT:dataquery/hooks/class.tx_dataquery_datafilterhook.php:&tx_dataquery_datafilterhook';
$GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['datafilter']['postprocessEmptyFilterCheck']['tx_dataquery'] = 'EXT:dataquery/hooks/class.tx_dataquery_datafilterhook.php:&tx_dataquery_datafilterhook';

	// Register wizard validation method with generic BE ajax calls handler
$GLOBALS['TYPO3_CONF_VARS']['BE']['AJAX']['dataquery::validate'] = 'typo3conf/ext/dataquery/class.tx_dataquery_ajax.php:tx_dataquery_Ajax->validate';
?>