...
class tx_dataquery_sqlbuilder_Workspace_Test extends tx_dataquery_sqlbuilder_Test {
	...
	public function setUp() {
		...
		self::$baseWorkspaceConditionForTTContent = 'AND ((tt_content.t3ver_state <= 0 AND tt_content.t3ver_oid = 0) OR (tt_content.t3ver_state = 0 AND tt_content.t3ver_wsid = 42) OR (tt_content.t3ver_state = 1 AND tt_content.t3ver_wsid = 42) OR (tt_content.t3ver_state = 3 AND tt_content.t3ver_wsid = 42)) ';
